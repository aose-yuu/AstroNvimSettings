...
return {
  ...
  n = {
    ...
    ["<leader>."] = { "$" },
    ["<leader>m"] = { "%" },
    ["<leader>fc"] = { "<cmdTelescope current_buffer_fuzzy_find<cr>", desc = "Find words in current file" },
    ["<leader><leader>"] = { "<C-w>w" },
    ["sv"] = { "<C-w>v", desc = "Vertical Split" },
    ["sh"] = { "<C-w>s", desc = "Horizontal Split" },
    ["<A-P>"] = { "<cmd>Telescope keymaps<cr>", desc = "Command pallet" },
